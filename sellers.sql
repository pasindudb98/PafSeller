...
--
-- Dumping data for table `sellerss`
--

INSERT INTO `sellerss` (`SellersId`, `FirstName`, `LastName`, `ContactNumber`, `Email`, `CompanyName`) VALUES
(8, 'rgarg', 'rgarg', 'argarg', 'arghaerg', 'argaerg');
...
--
ALTER TABLE `sellerss`
  MODIFY `SellersId` int(150) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
